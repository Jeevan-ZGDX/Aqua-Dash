...
export const CardShell = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => <div ref={ref} className={cn('rounded-xl border border-border bg-card shadow-card', className)} {...props} />,
);
